          ...
          <ul className="flex items-center gap-4 font-semibold">
            <li>
              <a
                ...
                className="border-primary-500/40 text-primary-400 hover:border-primary-400 hover:bg-primary-500/10 hover:text-primary-300 rounded-md border px-3 py-1.5 text-sm transition-colors"
              >
                Give feedback
              </a>
            </li>
